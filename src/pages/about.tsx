    ...
    <div>
      ...
      <main className={`${styles.mainContent} centerContainer`}>
        <section className={styles.contentBlock}>
          <img
            src="https://ik.imagekit.io/lrjseyuxi3m/todoapp/undraw_checklist__re_2w7v_1_EBpT5tUGgO.png?updatedAt=1636555587766"
            alt=""
          />
          <div className={styles.textBlock}>
            <h2>About the project</h2>
            <p>
              It&apos;s a simple <b>web app</b> project and provide some
              features to the user manage your projects and tasks.
            </p>
            <p>
              It was developed to be part of my{" "}
              <a
                target="_blank"
        ...
        <section className={styles.contentBlock}>
          <div className={styles.textBlock}>
            ...
            <p>
              The main tech behind it is the{" "}
          ...
          <img
            src="https://ik.imagekit.io/lrjseyuxi3m/todoapp/undraw_web_tech_xbG0aEh3UfI.png?updatedAt=1636583164512"
            alt=""
          />
        </section>
      </main>
